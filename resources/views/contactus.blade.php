...
<section class="section-contact" id="form1-4" data-rv-view="7288" style="overflow-x:hidden; margin:0">
    ...
    <div class="row justify-content-center pt-3">
        <div class="media-container-column col-lg-8" data-form-type="formoid">
            ...
            <form class="mbr-form" action="http://www.kridabudaya.com/" method="post" data-form-title="Krida Budaya"><input type="hidden" data-form-email="true" value="1KZP9iyPD6aKzuC4CRktqrwMWQIgCf2zf+1/8dCn2ldtRQXIV8JsZNf5CS6Rc570OCaj8AUxhvCvxxAV3jFoVHMzggzp0ZaaJRRYwr4I+ahEelXhHzHlnZFhOHrolfaH">
